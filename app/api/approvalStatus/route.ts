...
const approvalHandler = async (req: Request) => {
  ...
  const { email, name, status, lastname, empresa } = data

  try {
    await transporter.sendMail({
      ...mailOptions,
      subject: 'Novedades en el estado de su solicitud en SmartParking',
      text: `Hola ${name} ${lastname}, su solicitud ha sido ${status ? 'APROBADA' : 'RECHAZADA'} por el administrador de ${empresa}.`,
      html: `
      <!DOCTYPE html
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" role="presentation"
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0;padding-bottom:20px;font-size:0px"><img
                                    src="https://fctxcer.stripocdn.email/content/guids/CABINET_b894ff419b86100a24c0e3e52ee9a20e0c8718d1382d140c0582ad518e79fc7e/images/logo.png"
                                    alt="Logo"
                                    style="display:block;font-size:12px;border:0;outline:none;text-decoration:none"
                                    width="560" title="Logo" class="adapt-img" height="161"></td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="center"
                                  style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0px"><img
                                    src="https://fctxcer.stripocdn.email/content/guids/CABINET_a3448362093fd4087f87ff42df4565c1/images/78501618239341906.png"
                                    alt=""
                              ...
                              <tr>
                                <td align="center" class="es-m-txt-c" style="padding:0;Margin:0;padding-bottom:10px">
                                  <h1
                                    ...
                                    Felicidades, ya eres parte del equipo</h1>
                                </td>
                              </tr>
                              <tr>
                                <td align="center" style="padding:20px;Margin:0;font-size:0">
                              ...
                              <tr>
                                <td align="center" class="es-m-p0r es-m-p0l"
                                  ...
                                  <p
                                    ...
                                    Este es un mensaje de confirmación de parte del equipo de {SMARTPARKING}, queremos
                                    informarle que la empresa {EMPRESA} ha aceptado su solicitud como colaborador. Para
                                    iniciar sesión, haga clic en el botón aquí abajo, o en el siguiente enlace:</p>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0;padding-bottom:35px">
                                  <p
                                    ...
                                    Smart parking Ltda. Todos los derechos reservados,</p>
                                  <p
                                    style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;letter-spacing:0;color:#333333;font-size:12px">
                                    Copyright 2023 - 2024.</p>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="center" class="es-infoblock" style="padding:0;Margin:0">
                                  <p
                                    ...
                                    No longer want to receive these emails?&nbsp;<a href="" target="_blank"
