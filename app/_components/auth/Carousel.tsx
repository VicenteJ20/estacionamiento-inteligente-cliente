...
const CarouselAuth = () => {
  ...
  return (
    <section className='bg-blue-500 p-10 rounded-l-2xl rounded-r hidden md:flex flex-col gap-4 justify-between items-center'>
      <header className='flex flex-row gap-4 items-center justify-self-start w-full text-white'>
      ...
      <article className="xl:pb-20 flex flex-col gap-2 text-center justify-center items-center">
        <figure className=''>
          <Image src={imageUrl} alt='promotional-image' width={900} height={900} />
        </figure>
        <div className='flex flex-col gap-3 items-center text-center px-20'>
